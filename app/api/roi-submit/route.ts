    ...
    <body style="margin:0; padding:0; background:#F9FAFB; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
      <div style="max-width: 600px; margin: 40px auto; background: #FFFFFF; border-radius: 16px; overflow: hidden; border: 1px solid #E5E7EB;">
        ...
        <div style="background: linear-gradient(135deg, #0B0F1A, #0A3D7C); padding: 32px 40px;">
          ...
          <h1 style="margin: 0; color: #4FE0FF; font-size: 22px; font-weight: 700;">New ROI Calculator Submission</h1>
        </div>
        ...
        <div style="padding: 32px 40px;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
            <div style="background: #F9FAFB; border: 1px solid #E5E7EB; border-radius: 12px; padding: 16px; text-align: center;">
              ...
              <p style="margin: 0; font-size: 28px; font-weight: 800; color: #4FE0FF;">${results.hoursSaved.toLocaleString()}</p>
            </div>
            <div style="background: #F9FAFB; border: 1px solid #E5E7EB; border-radius: 12px; padding: 16px; text-align: center;">
              <p style="margin: 0 0 4px; color: #6B7280; font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px;">Cost Saved/Year</p>
              <p style="margin: 0; font-size: 28px; font-weight: 800; color: #4FE0FF;">${formatCurrency(results.costSaved)}</p>
            </div>
            <div style="background: #F9FAFB; border: 1px solid #E5E7EB; border-radius: 12px; padding: 16px; text-align: center;">
              <p style="margin: 0 0 4px; color: #6B7280; font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px;">FTE Equivalent</p>
              <p style="margin: 0; font-size: 28px; font-weight: 800; color: #4FE0FF;">${results.fteEquivalent}</p>
            </div>
            <div style="background: #F9FAFB; border: 1px solid #E5E7EB; border-radius: 12px; padding: 16px; text-align: center;">
