...
export default function BlogClient({ posts, placeholderPosts }: BlogClientProps) {
                ...
                <Link key={post._id} href={`/blog/${post.slug.current}`}>
                  ...
                  >
                    {post.mainImage ? (
                      ...
                      <div
                        className="h-48"
                        style={{ backgroundColor: theme === "dark" ? "#243049" : "#E5E7EB" }}
                      />
                    )}
                    <div className="p-6">
                      <div className="flex items-center gap-2 mb-3">
                        {post.category && (
                          <span
                            ...
                            style={{
                              backgroundColor: theme === "dark" ? "rgba(61,207,237,0.1)" : "rgba(26,60,200,0.1)",
                              color: "#3DCFED",
                            }}
                          >
                            {post.category}
                      ...
                      <h2 className="text-lg font-bold mb-2" style={{ color: theme === "dark" ? "#3DCFED" : "#0D1F6E" }}>
                        {post.title}
                      </h2>
                      {post.excerpt && (
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {placeholderPosts.map((post) => (
                  ...
                  >
                    <div className="h-40" style={{ backgroundColor: theme === "dark" ? "#243049" : "#E5E7EB" }} />
                    <div className="p-6">
                      <div className="flex items-center gap-2 mb-3">
                        <span
                          className="text-xs font-medium px-2 py-0.5 rounded-full"
              ...
              <div className="text-center mt-12">
                <p className="text-sm" style={{ color: theme === "dark" ? "#6B7280" : "#9CA3AF" }}>
